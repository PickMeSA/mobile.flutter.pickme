...
class _HomePageState extends BasePageState<HomePage, HomeBloc> {
  ...
  late String? _profileImageUri = widget.profileEntity.pictureEntity?.url;
  late final profileImageCache = locator<ProgramCache>(); // Violating the responsibility of the View layer, Should not leave here, but the fix requires a full redesign
  ...
  _onRefresh() async {
    ...
    _profileImageUri = profileImageCache.profileUrl ?? _profileImageUri;
      ...
      builder: (context, state) {
        ...
        switch (state.dataState) {
          ...
          case DataState.reloading:
            if (state is JobsHiringLandingPageEnteredState) {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        InkWell(
                          onTap: () =>
                              getBloc().add(NextAppointmentCardClickedEvent()),
                          child: Card(
                            elevation: 8,
                            child: ListTile(
                              leading: const Icon(Iconsax.briefcase),
                              title:
                                  wText(getLocalization().yourNextAppointment),
                              trailing: const Icon(
                                Icons.arrow_forward,
                                size: 20,
                              ),
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: <Widget>[
                                    Expanded(
                                        child: Text(getBloc().currentMonth,
                                ...
                                CalendarCarousel<Event>(
                                  onDayPressed: (date, events) {
                                    getBloc().add(CalendarDateSelectedEvent(
                                        dateTime: date, events: events));
                                  },
                                  ...
                                  onCalendarChanged: (DateTime date) {
                                    getBloc().add(
                                        CalendarChangedEvent(dateTime: date));
                                  },
                                  weekendTextStyle:
                            ...
                            child: (getBloc().paginatedCandidates != null)
                                ? ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      CandidateProfileEntity candidate =
                                          getBloc()
                                              .paginatedCandidates!
                                              .candidates[index];
                                      return AppCandidateProfile(
                                        ...
                                        jobTitle: candidate.jobTitle ??
                                            getLocalization().noJobDescription,
