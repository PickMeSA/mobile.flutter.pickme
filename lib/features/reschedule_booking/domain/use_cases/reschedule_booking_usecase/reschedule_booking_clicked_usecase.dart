...
@Injectable()
class RescheduleBookingClickedUseCase extends BaseUseCase<RescheduleBookingClickedUseCaseParams, bool>{
  ...
  @override
  Future<bool> call({RescheduleBookingClickedUseCaseParams? params}) async {
    try{
