...
class AlternativeRequestDetailsBloc
    ...
    AlternativeRequestDetailsBloc({required this.rescheduleBookingClickedUseCase}): super(AlternativeRequestDetailsPageInitState()) {
    ...
    Future<void> _onRescheduleBookingEvent(
        ...
        Emitter<AlternativeRequestDetailsPageState> emit
        )async{
