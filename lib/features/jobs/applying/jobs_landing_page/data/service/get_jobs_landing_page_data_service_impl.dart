...
import 'package:pickme/shared/services/remote/api_service/industries_service/industry_service_impl.dart';
  ...
  Future<JobsLandingPageEntity> getLandingPageData() async {
    try {
      ...
      if(jobsResponse.statusCode!=200){
        ...
        jobsResponse.data.forEach((value) {
          recommended.add(JobEntity.fromResponse(value));
        });

      logger.d("services fetched");
      ...
      if (response.statusCode == 200) {
        ...
        return JobsLandingPageEntity(recommendedJobs: [], services: services);
      }
      throw "An error occurred";
    }catch (e){
      rethrow;
