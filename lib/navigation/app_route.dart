...
import 'package:pickme/features/id_reason/presentation/id_reason_page.dart';
...
import 'package:pickme/features/reusable_notification_page/presentation/reusable_notification_page.dart';
...
class AppRouter extends _$AppRouter{
  ...
  List<AutoRoute> get routes =>[
    ...
    AnimatedRoute(page: RegisterAccountStep1Route.page, initial: true),
    ...
    AnimatedRoute(page: IdReasonRoute.page)
