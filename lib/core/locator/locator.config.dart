...
import '../../shared/features/otp/domain/use_cases/otp_usecase/register_otp_complete_usecase.dart'
    as _i27;
import '../../shared/features/otp/presentation/bloc/otp_bloc.dart' as _i116;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i15.FinalDetailsBloc>(() =>
        _i15.FinalDetailsBloc(uploadFileUseCase: gh<_i16.UploadFileUseCase>()));
    ...
    gh.factory<_i80.UploadFileService>(
        () => _i81.UploadFileServiceImpl(apiService: gh<_i44.ApiService>()));
    gh.singleton<_i82.UserService>(
        _i83.UserServiceImpl(apiService: gh<_i44.ApiService>()));
    gh.factory<_i84.AddSkillsGetIndustryListRepository>(() =>
        _i85.AddSkillsGetIndustryListRepositoryImpl(
            industryService: gh<_i51.IndustryService>()));
    gh.factory<_i86.AddSkillsGetIndustryListUseCase>(() =>
        _i86.AddSkillsGetIndustryListUseCase(
            addSkillsGetIndustryListRepository:
                gh<_i84.AddSkillsGetIndustryListRepository>()));
    gh.factory<_i87.AddSkillsGetSkillsListRepository>(() =>
        _i88.AddSkillsGetSkillsListRepositoryImpl(
            skillsService: gh<_i70.SkillsService>()));
    gh.factory<_i89.AddSkillsGetSkillsListUseCase>(() =>
        _i89.AddSkillsGetSkillsListUseCase(
            addSkillsGetSkillsListRepository:
                gh<_i87.AddSkillsGetSkillsListRepository>()));
    gh.factory<_i90.AddSkillsSubmitRemoteSkillsAndIndustryRepository>(() =>
        _i91.AddSkillsSubmitRemoteSkillsAndIndustryRepositoryImpl(
            profileService: gh<_i64.ProfileService>()));
    gh.factory<_i92.AddSkillsSubmitRemoteSkillsAndIndustryUseCase>(() =>
        _i92.AddSkillsSubmitRemoteSkillsAndIndustryUseCase(
            addSkillsSubmitRemoteSkillsAndIndustryRepository:
                gh<_i90.AddSkillsSubmitRemoteSkillsAndIndustryRepository>()));
    gh.factory<_i93.BankDetailsSubmittedRepository>(() =>
        _i94.BankDetailsSubmittedRepositoryImpl(
            profileService: gh<_i64.ProfileService>()));
    gh.factory<_i95.BankDetailsSubmittedUseCase>(() =>
        _i95.BankDetailsSubmittedUseCase(
            bankDetailsSubmittedRepository:
                gh<_i93.BankDetailsSubmittedRepository>()));
    ...
    gh.factory<_i107.OTPSaveRemoteProfileDataRepository>(() =>
        _i108.OTPSaveRemoteProfileDataRepositoryImpl(
            userService: gh<_i82.UserService>()));
    ...
    gh.factory<_i114.UploadFileRepository>(() => _i115.UploadFileRepositoryImpl(
        uploadFileService: gh<_i80.UploadFileService>()));
    gh.factory<_i116.otpBloc>(() => _i116.otpBloc(
    ...
    gh.factory<_i117.AddSkillsBloc>(() => _i117.AddSkillsBloc(
          addSkillsGetIndustryListUseCase:
              gh<_i86.AddSkillsGetIndustryListUseCase>(),
          addSkillsGetSkillsListUseCase:
              gh<_i89.AddSkillsGetSkillsListUseCase>(),
          addSkillsSubmitRemoteSkillsAndIndustryUseCase:
              gh<_i92.AddSkillsSubmitRemoteSkillsAndIndustryUseCase>(),
        ));
    gh.factory<_i118.BankDetailsBloc>(() => _i118.BankDetailsBloc(
        bankDetailsSubmittedUseCase: gh<_i95.BankDetailsSubmittedUseCase>()));
    return this;
  }
}
