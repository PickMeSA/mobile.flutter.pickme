...
import '../../features/register/domain/usecase/continue_clicked_usecase.dart'
    as _i28;
import '../../features/register/presentation/bloc/register__bloc.dart' as _i32;
...
import '../../shared/features/otp/domain/use_cases/otp_usecase/otp_get_credential_usecase.dart'
    as _i31;
import '../../shared/features/otp/presentation/bloc/otp_bloc.dart' as _i33;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i29.OTPGetCredentialRepository>(() =>
        _i30.OTPGetCredentialRepositoryImpl(
            authentication: gh<_i24.Authentication>()));
    gh.factory<_i31.OTPGetCredentialUseCase>(() => _i31.OTPGetCredentialUseCase(
        oTPGetCredentialRepository: gh<_i29.OTPGetCredentialRepository>()));
    gh.factory<_i32.RegisterBloc>(() => _i32.RegisterBloc(
        continueClickedUseCase: gh<_i28.ContinueClickedUseCase>()));
    gh.factory<_i33.otpBloc>(() => _i33.otpBloc(
        otpGetCredentialUseCase: gh<_i31.OTPGetCredentialUseCase>()));
    return this;
  }
}
