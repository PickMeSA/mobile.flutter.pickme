...
import '../../features/login/domain/use_cases/login_usecase/login_continue_clicked_usecase.dart'
    as _i56;
import '../../features/login/presentation/bloc/login_bloc.dart' as _i108;
...
import '../../shared/features/otp/domain/use_cases/otp_usecase/register_otp_complete_usecase.dart'
    as _i28;
import '../../shared/features/otp/presentation/bloc/otp_bloc.dart' as _i119;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i15.FinalDetailsBloc>(() => _i15.FinalDetailsBloc(
          uploadFileUseCase: gh<_i16.UploadFileUseCase>(),
          submitFinalDetailsUseCase: gh<_i17.SubmitFinalDetailsUseCase>(),
        ));
    ...
    gh.singleton<_i47.Authentication>(
        _i48.PFirebaseAuthentication(firebaseAuth: gh<_i18.FirebaseAuth>()));
    ...
    gh.factory<_i73.SubmitFinalDetailsRepository>(() =>
        _i74.SubmitFinalDetailsRepositoryImpl(
            profileService: gh<_i65.ProfileService>()));
    ...
    gh.factory<_i81.TermsAndConditionsService>(() =>
        _i82.TermsAndConditionsServiceImpl(apiService: gh<_i45.ApiService>()));
    gh.factory<_i83.UploadFileService>(
        () => _i84.UploadFileServiceImpl(apiService: gh<_i45.ApiService>()));
    gh.singleton<_i85.UserService>(
        _i86.UserServiceImpl(apiService: gh<_i45.ApiService>()));
    ...
    gh.factory<_i109.MembershipInformationBloc>(() =>
        _i109.MembershipInformationBloc(
            getMembershipInformationUseCase:
                gh<_i101.GetMembershipInformationUseCase>()));
    gh.factory<_i110.OTPSaveRemoteProfileDataRepository>(() =>
        _i111.OTPSaveRemoteProfileDataRepositoryImpl(
            userService: gh<_i85.UserService>()));
    gh.factory<_i112.OTPSaveRemoteProfileDataUseCase>(() =>
        _i112.OTPSaveRemoteProfileDataUseCase(
            oTPSaveRemoteProfileDataRepository:
                gh<_i110.OTPSaveRemoteProfileDataRepository>()));
    gh.factory<_i113.QualificationsBloc>(() => _i113.QualificationsBloc(
        submitRemoteQualificationAndExperienceUseCase:
            gh<_i77.SubmitRemoteQualificationAndExperienceUseCase>()));
    gh.factory<_i114.RateAndWorkTimesBloc>(() => _i114.RateAndWorkTimesBloc(
        submitRemoteRateAndWorkTimesUseCase:
            gh<_i80.SubmitRemoteRateAndWorkTimesUseCase>()));
    gh.factory<_i115.SetupProfileBloc>(() => _i115.SetupProfileBloc(
    ...
    gh.factory<_i116.TermsAndConditionsBloc>(() => _i116.TermsAndConditionsBloc(
        getRemoteTermsAndConditionsUseCase:
            gh<_i107.GetRemoteTermsAndConditionsUseCase>()));
    gh.factory<_i117.UploadFileRepository>(() => _i118.UploadFileRepositoryImpl(
        uploadFileService: gh<_i83.UploadFileService>()));
    gh.factory<_i119.otpBloc>(() => _i119.otpBloc(
          ...
          otpSaveRemoteProfileDataUseCase:
              gh<_i112.OTPSaveRemoteProfileDataUseCase>(),
        ));
    gh.factory<_i120.AddSkillsBloc>(() => _i120.AddSkillsBloc(
    ...
    gh.factory<_i121.BankDetailsBloc>(() => _i121.BankDetailsBloc(
        bankDetailsSubmittedUseCase: gh<_i98.BankDetailsSubmittedUseCase>()));
    return this;
  }
}
