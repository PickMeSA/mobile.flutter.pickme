...
import '../../features/location/data/repository_impl/location_repository_impl/location_get_current_location_repository_impl.dart'
    as _i22;
import '../../features/location/domain/repository/location_repository/location_get_current_location_repository.dart'
    as _i21;
import '../../features/location/domain/use_cases/location_usecase/location_get_current_location_usecase.dart'
    as _i23;
import '../../features/location/presentation/bloc/location_bloc.dart' as _i57;
...
import '../../features/login/domain/use_cases/login_usecase/login_continue_clicked_usecase.dart'
    as _i60;
import '../../features/login/presentation/bloc/login_bloc.dart' as _i105;
...
import '../../shared/features/otp/domain/use_cases/otp_usecase/register_otp_complete_usecase.dart'
    as _i31;
import '../../shared/features/otp/presentation/bloc/otp_bloc.dart' as _i114;
...
import '../../shared/services/local/GeoLocation/geo_location.dart' as _i18;
import '../../shared/services/local/GeoLocation/geo_location_impl.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i18.GeoLocationService>(() => _i19.GeoLocationServiceImpl());
    gh.factory<_i20.LandingBloc>(() => _i20.LandingBloc());
    gh.factory<_i21.LocationGetCurrentLocationRepository>(() =>
        _i22.LocationGetCurrentLocationRepositoryImpl(
            geoLocationService: gh<_i18.GeoLocationService>()));
    gh.factory<_i23.LocationGetCurrentLocationUseCase>(() =>
        _i23.LocationGetCurrentLocationUseCase(
            locationGetCurrentLocationRepository:
                gh<_i21.LocationGetCurrentLocationRepository>()));
    ...
    gh.singleton<_i48.ApiService>(_i49.DioApiService(dio: gh<_i15.Dio>()));
    gh.singleton<_i50.Authentication>(
        _i51.PFirebaseAuthentication(firebaseAuth: gh<_i17.FirebaseAuth>()));
    ...
    gh.singleton<_i55.IndustryService>(
        _i56.IndustryServiceImpl(apiService: gh<_i48.ApiService>()));
    gh.factory<_i57.LocationBloc>(() => _i57.LocationBloc(
        locationGetCurrentLocationUseCase:
            gh<_i23.LocationGetCurrentLocationUseCase>()));
    ...
    gh.singleton<_i64.MembershipDetailsService>(
        _i65.MembershipDetailsServiceImpl(apiService: gh<_i48.ApiService>()));
    ...
    gh.singleton<_i69.ProfileService>(
        _i70.ProfileServiceImpl(apiService: gh<_i48.ApiService>()));
    ...
    gh.singleton<_i75.SkillsService>(
        _i76.SkillsServiceImpl(apiService: gh<_i48.ApiService>()));
    gh.factory<_i77.SubmitRemoteQualificationAndExperienceRepository>(() =>
        _i78.SubmitRemoteQualificationAndExperienceRepositoryImpl(
            profileService: gh<_i69.ProfileService>()));
    gh.factory<_i79.SubmitRemoteQualificationAndExperienceUseCase>(() =>
        _i79.SubmitRemoteQualificationAndExperienceUseCase(
            submitRemoteQualificationAndExperienceRepository:
                gh<_i77.SubmitRemoteQualificationAndExperienceRepository>()));
    gh.factory<_i80.SubmitRemoteRateAndWorkTimesRepository>(() =>
        _i81.SubmitRemoteRateAndWorkTimesRepositoryImpl(
            profileService: gh<_i69.ProfileService>()));
    gh.factory<_i82.SubmitRemoteRateAndWorkTimesUseCase>(() =>
        _i82.SubmitRemoteRateAndWorkTimesUseCase(
            submitRemoteRateAndWorkTimesRepository:
                gh<_i80.SubmitRemoteRateAndWorkTimesRepository>()));
    gh.factory<_i83.TermsAndConditionsService>(() =>
        _i84.TermsAndConditionsServiceImpl(apiService: gh<_i48.ApiService>()));
    gh.singleton<_i85.UserService>(
        _i86.UserServiceImpl(apiService: gh<_i48.ApiService>()));
    gh.factory<_i87.AddSkillsGetIndustryListRepository>(() =>
        _i88.AddSkillsGetIndustryListRepositoryImpl(
            industryService: gh<_i55.IndustryService>()));
    ...
    gh.factory<_i90.AddSkillsGetSkillsListRepository>(() =>
        _i91.AddSkillsGetSkillsListRepositoryImpl(
            skillsService: gh<_i75.SkillsService>()));
    ...
    gh.factory<_i96.GetMembershipInformationRepository>(() =>
        _i97.GetMembershipInformationRepositoryImpl(
            membershipDetailsService: gh<_i64.MembershipDetailsService>()));
    gh.factory<_i98.GetMembershipInformationUseCase>(() =>
        _i98.GetMembershipInformationUseCase(
            getMembershipInformationRepository:
                gh<_i96.GetMembershipInformationRepository>()));
    gh.factory<_i99.GetRemoteProfileRepository>(() =>
        _i100.GetRemoteProfileRepositoryImpl(
            profileService: gh<_i69.ProfileService>()));
    gh.factory<_i101.GetRemoteProfileUseCase>(() =>
        _i101.GetRemoteProfileUseCase(
            getRemoteProfileRepository: gh<_i99.GetRemoteProfileRepository>()));
    gh.factory<_i102.GetRemoteTermsAndConditionsRepository>(() =>
        _i103.GetRemoteTermsAndConditionsRepositoryImpl(
            termsAndConditionsService: gh<_i83.TermsAndConditionsService>()));
    gh.factory<_i104.GetRemoteTermsAndConditionsUseCase>(() =>
        _i104.GetRemoteTermsAndConditionsUseCase(
            getRemoteTermsAndConditionsRepository:
                gh<_i102.GetRemoteTermsAndConditionsRepository>()));
    gh.factory<_i105.LoginBloc>(() => _i105.LoginBloc(
        loginContinueClickedUsecase: gh<_i60.LoginContinueClickedUseCase>()));
    gh.factory<_i106.MembershipInformationBloc>(() =>
        _i106.MembershipInformationBloc(
            getMembershipInformationUseCase:
                gh<_i98.GetMembershipInformationUseCase>()));
    ...
    gh.factory<_i110.QualificationsBloc>(() => _i110.QualificationsBloc(
        submitRemoteQualificationAndExperienceUseCase:
            gh<_i79.SubmitRemoteQualificationAndExperienceUseCase>()));
    gh.factory<_i111.RateAndWorkTimesBloc>(() => _i111.RateAndWorkTimesBloc(
        submitRemoteRateAndWorkTimesUseCase:
            gh<_i82.SubmitRemoteRateAndWorkTimesUseCase>()));
    gh.factory<_i112.SetupProfileBloc>(() => _i112.SetupProfileBloc(
    ...
    gh.factory<_i113.TermsAndConditionsBloc>(() => _i113.TermsAndConditionsBloc(
        getRemoteTermsAndConditionsUseCase:
            gh<_i104.GetRemoteTermsAndConditionsUseCase>()));
    gh.factory<_i114.otpBloc>(() => _i114.otpBloc(
          getRemoteProfileUseCase: gh<_i101.GetRemoteProfileUseCase>(),
    ...
    gh.factory<_i115.AddSkillsBloc>(() => _i115.AddSkillsBloc(
