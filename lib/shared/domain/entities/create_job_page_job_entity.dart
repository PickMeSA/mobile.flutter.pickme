...
class CreateJobPageJobEntity {
  ...
  CreateJobPageJobEntity({required this.title, required this.description, required this.address, required this.status, this.startDate, this.endDate, this.startTime, required this.imFlexible, required this.estimatedHours, required this.lat, required this.lng, required this.images, required this.skills, required this.industryId, this.offeredTo});
